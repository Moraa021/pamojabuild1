...
func TestRegisteredAPIContractRoutes(t *testing.T) {
	...
	expected := map[string]bool{
		...
		"POST /api/v1/tasks/:slug/start":                            false,
		"POST /api/v1/tasks/:slug/submit-for-verification":          false,
		"POST /api/v1/tasks/:slug/verify":                           false,
		"GET /api/v1/tasks/:slug/state-history":                     false,
		"POST /api/v1/tasks/:slug/apply":                            false,
		"POST /api/v1/tasks/:slug/submissions":                      false,
		"GET /api/v1/tasks/:slug/trustees":                          false,
		"POST /api/v1/tasks/:slug/trustees/nominations":             false,
		"POST /api/v1/tasks/:slug/trustees/accept":                  false,
		"POST /api/v1/tasks/:slug/trustees/keys":                    false,
		"POST /api/v1/tasks/:slug/trustees/keys/rotation-challenge": false,
		"POST /api/v1/tasks/:slug/trustees/keys/rotate":             false,
		"POST /api/v1/tasks/:slug/trustees/:index/replace":          false,
