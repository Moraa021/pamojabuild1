...
type CoSignPayoutRequest struct {
	Layer1PsbtSignatureFragment string `json:"layer1_psbt_signature_fragment" binding:"required,max=65536"`
	Layer2WebCryptoSignature    string `json:"layer2_web_crypto_signature" binding:"required,max=65536"`
}

type CoSignPayoutResponse struct {
