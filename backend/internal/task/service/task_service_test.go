...
func (m *mockTaskRepo) UpdateStatus(ctx context.Context, slug string, status string) error {
	return nil
}
func (m *mockTaskRepo) UpdateFinancialState(ctx context.Context, slug string, state string) error {
	return nil
}
...
func TestListTasksRejectsOutOfRangePageSize(t *testing.T) {
	svc := NewTaskService(&mockTaskRepo{}, nil)
