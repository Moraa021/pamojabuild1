...
// LND's lnrpc package uses Lightning Labs' protobuf fork for hex byte display.
// Go does not inherit replace directives from dependencies, so the app must
// mirror LND's replacement here.
